...
namespace Fmi
{
  ...
  public:
	...
	template <typename T>
	T optional(const std::string& theName, const T& theDefault, const T& theLoLimit, const T& theHiLimit) const;
  ...
  template <>
  inline
  std::string Config::require<std::string>(const std::string& theName) const
  {
  ...
  template <>
  inline
  bool Config::require<bool>(const std::string& theName) const
  {
  ...
  template <>
  inline
  int Config::require<int>(const std::string& theName) const
  {
  ...
  template <>
  inline
  double Config::require<double>(const std::string& theName) const
  {
 ...
 template <typename T>
  inline
  T Config::require(const std::string& theName) const
  {
	try
	  {
  ...
  template <typename T>
  inline
  T Config::require(const std::string& theName, const T& theLoLimit, const T& theHiLimit) const
  {
  ...
  template <>
  inline
  std::string Config::optional<std::string>(const std::string& theName, const std::string& theDefault) const
  {
  ...
  template <>
  inline
  bool Config::optional<bool>(const std::string& theName, const bool& theDefault) const
  {
  ...
  template <>
  inline
  int Config::optional<int>(const std::string& theName, const int& theDefault) const
  {
  ...
  template <>
  inline
  double Config::optional<double>(const std::string& theName, const double& theDefault) const
  {
 ...
 template <typename T>
  inline
  T Config::optional(const std::string& theName, const T& theDefault, const T& theLoLimit, const T& theHiLimit) const
  {
