...
namespace TextGen
{
  namespace WeekdayTools
  {
	...
	std::string night_against_weekday(const TextGenPosixTime & theTime, TextGen::WeatherHistory& theHistory);
	std::string until_weekday_morning(const TextGenPosixTime & theTime, TextGen::WeatherHistory& theHistory);
	std::string until_weekday_evening(const TextGenPosixTime & theTime, TextGen::WeatherHistory& theHistory);
	std::string until_weekday_time(const TextGenPosixTime & theTime, TextGen::WeatherHistory& theHistory);
	std::string from_weekday(const TextGenPosixTime & theTime, TextGen::WeatherHistory& theHistory);
	std::string from_weekday_morning(const TextGenPosixTime & theTime, TextGen::WeatherHistory& theHistory);
	std::string from_weekday_evening(const TextGenPosixTime & theTime, TextGen::WeatherHistory& theHistory);
	std::string from_weekday_time(const TextGenPosixTime & theTime, TextGen::WeatherHistory& theHistory);
	std::string on_weekday_morning(const TextGenPosixTime & theTime, TextGen::WeatherHistory& theHistory);
	std::string on_weekday_forenoon(const TextGenPosixTime & theTime, TextGen::WeatherHistory& theHistory);
	std::string on_weekday_afternoon(const TextGenPosixTime & theTime, TextGen::WeatherHistory& theHistory);
	std::string on_weekday_evening(const TextGenPosixTime & theTime, TextGen::WeatherHistory& theHistory);
