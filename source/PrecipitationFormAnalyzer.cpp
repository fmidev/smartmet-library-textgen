...
/*!
 * \file
 * \brief Implementation of class WeatherAnalysis::PrecipitationFormAnalyzer
 */
// ======================================================================
/*!
 * \class WeatherAnalysis::PrecipitationFormAnalyzer
 *
 * \brief Precipitation form analysis functions
 *
 */
// ======================================================================
...
namespace WeatherAnalysis
{
  ...
  // ----------------------------------------------------------------------
  /*!
   * \brief Analyze precipitation form in an area
   *
  ...
  const WeatherResult
  PrecipitationFormAnalyzer::analyze(const AnalysisSources & theSources,
  ...
  {
	const string varname = "textgen::precipitationform";
	const string parname = "PrecipitationForm";
