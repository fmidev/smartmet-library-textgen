...
namespace WeatherAnalysis
{
  ...
  MorningAndEveningPeriodGenerator::MorningAndEveningPeriodGenerator(const WeatherPeriod & theMainPeriod,
  ...
  MorningAndEveningPeriodGenerator::size_type
  MorningAndEveningPeriodGenerator::size() const
  {
