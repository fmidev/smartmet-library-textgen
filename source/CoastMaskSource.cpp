...
namespace WeatherAnalysis
{
  ...
  // ----------------------------------------------------------------------
  /*!
   * \brief Implementation hiding detail for WeatherAnalysis::CoastMaskSource
   */
  // ----------------------------------------------------------------------
  ...
  CoastMaskSource::mask_type
  CoastMaskSource::Pimple::find(const WeatherId & theID,
								const WeatherArea & theArea) const
  {
  ...
  CoastMaskSource::mask_type
  CoastMaskSource::Pimple::create_mask(const WeatherArea & theArea,
									   const std::string & theData,
									   const WeatherSource & theWeatherSource) const
  {
  ...
  CoastMaskSource::CoastMaskSource(const WeatherArea & theCoast)
  ...
  const CoastMaskSource::mask_type
  CoastMaskSource::mask(const WeatherArea & theArea,
						const std::string & theData,
						const WeatherSource & theWeatherSource) const
  {
	if(theArea.isPoint())
  ...
  const CoastMaskSource::masks_type
  CoastMaskSource::masks(const WeatherArea & theArea,
						 const std::string & theData,
						 const WeatherSource & theWeatherSource) const
  {
	throw WeatherAnalysisError("CoastMaskSource::masks not implemented");
  }
