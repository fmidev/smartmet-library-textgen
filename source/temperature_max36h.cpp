...
namespace TextGen
{
							  ...
							  WeatherResult & theMax)
  {
	...
	WeatherParameter get_fractile(MessageLogger & theLog,
								  ...
								  const AnalysisSources& theSources)
  {
	...
	if(theValue <= result.value())
	  return NormalMaxTemperatureF02;
	...
	if(theValue <= result.value())
	  return NormalMaxTemperatureF12;
	...
	if(theValue <= result.value())
	  return NormalMaxTemperatureF37;
	...
	if(theValue <= result.value())
	  return NormalMaxTemperatureF50;
	...
	if(theValue <= result.value())
	  return NormalMaxTemperatureF63;
	...
	if(theValue <= result.value())
	  return NormalMaxTemperatureF88;

	/*
	WeatherResult fractiles98 = gc.analyze(theFakeVariable,
										   theSources,
	...
	*/
	...
	return NormalMaxTemperatureF98;
  ...
  const Paragraph TemperatureStory::max36h() const
  {
