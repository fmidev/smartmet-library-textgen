...
std::string Config::optionalString(const std::string& theName,
...
bool Config::optionalBoolean(const std::string& theName,
							 bool theDefault) const
{
  SettingsData& params(get_settings());
...
double Config::optionalDouble(const std::string& theName,
							  double theDefault) const
{
  SettingsData& params(get_settings());
