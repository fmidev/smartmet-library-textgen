...
namespace WeatherAnalysis
{
  ...
  // ----------------------------------------------------------------------
  /*!
   * \brief Analyze thunder in an area
   *
  ...
  WeatherResult
  ThunderAnalyzer::analyze(const AnalysisSources & theSources,
  ...
  {
	const string varname = "textgen::thunder";
	const string parname = "ProbabilityThunderstorm";
