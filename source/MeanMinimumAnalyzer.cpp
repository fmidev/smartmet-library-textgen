...
/*!
 * \file
 * \brief Implementation of class WeatherAnalysis::MeanMinimumAnalyzer
 */
// ======================================================================
...
namespace WeatherAnalysis
{
  ...
  // ----------------------------------------------------------------------
  /*!
   * \brief Analyze parameter area mean of time minimums
   *
   * This interface permits dividing the time interval into
   * subintervals with their own integrator. This allows us to
   * calculate for example the mean of daily minimum temperatures.
   *
  ...
  WeatherResult
  MeanMinimumAnalyzer::analyze(const AnalysisSources & theSources,
