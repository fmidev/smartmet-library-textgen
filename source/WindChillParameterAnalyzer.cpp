...
namespace WeatherAnalysis
{
  ...
  WeatherResult
  WindChillParameterAnalyzer::analyze(const AnalysisSources & theSources,
  ...
  {
	auto_ptr<FunctionAnalyzer> analyzer(new WindChillFunctionAnalyzer(theAreaFunction,theTimeFunction,theSubTimeFunction));
