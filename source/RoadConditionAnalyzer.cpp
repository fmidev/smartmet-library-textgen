...
/*!
 * \file
 * \brief Implementation of class WeatherAnalysis::RoadConditionAnalyzer
 */
// ======================================================================
/*!
 * \class WeatherAnalysis::RoadConditionAnalyzer
 *
 * \brief Road condition analysis functions
 *
 */
// ======================================================================
...
namespace WeatherAnalysis
{
  ...
  // ----------------------------------------------------------------------
  /*!
   * \brief Analyze road condition in an area
   *
  ...
  WeatherResult
  RoadConditionAnalyzer::analyze(const AnalysisSources & theSources,
  ...
  {
	const string varname = "textgen::roadcondition";
	const string parname = "RoadCondition";
