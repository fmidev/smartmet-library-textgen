...
/*!
 * \file
 * \brief Implementation of class WeatherAnalysis::MaxSumAnalyzer
 */
// ======================================================================
...
namespace WeatherAnalysis
{
  ...
  // ----------------------------------------------------------------------
  /*!
   * \brief Analyze parameter area maximum of time sums
   *
   * This interface permits dividing the time interval into
   * subintervals with their own integrator. This allows us to
   * calculate for example the maximum of daily precipitation amounts.
   *
  ...
  WeatherResult
  MaxSumAnalyzer::analyze(const AnalysisSources & theSources,
	...
	if(theArea.isNamed())
	  {
		...
		NFmiDataModifierSum timemodifier;
