...
namespace TextGen
{
  ...
  Paragraph WindStory::range() const
  {
	...
	const WeatherResult minresult =
	  forecaster.analyze(itsVar+"::fake::speed::minimum",
						 itsSources,
						 WindSpeed,
						 Mean,
						 Minimum,
	...
	const WeatherResult maxresult =
	  forecaster.analyze(itsVar+"::fake::speed::maximum",
						 itsSources,
						 WindSpeed,
						 Mean,
						 Maximum,
	...
	const WeatherResult meanresult =
	  forecaster.analyze(itsVar+"::fake::speed::mean",
						 itsSources,
						 WindSpeed,
						 Mean,
						 Mean,
	...
	const WeatherResult dirresult =
	  forecaster.analyze(itsVar+"::fake::direction::mean",
						 itsSources,
						 WindDirection,
						 Mean,
						 Mean,
