...
/*!
 * \file
 * \brief Implementation of class WeatherAnalysis::MinSumAnalyzer
 */
// ======================================================================
...
namespace WeatherAnalysis
{
  ...
  // ----------------------------------------------------------------------
  /*!
   * \brief Analyze parameter area minimum of time sums
   *
   * This interface permits dividing the time interval into
   * subintervals with their own integrator. This allows us to
   * calculate for example the minimum of daily precipitation amounts.
   *
  ...
  WeatherResult
  MinSumAnalyzer::analyze(const AnalysisSources & theSources,
