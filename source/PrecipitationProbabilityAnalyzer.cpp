...
/*!
 * \file
 * \brief Implementation of class WeatherAnalysis::PrecipitationProbabilityAnalyzer
 */
// ======================================================================
/*!
 * \class WeatherAnalysis::PrecipitationProbabilityAnalyzer
 *
 * \brief Precipitation probability analysis functions
 *
 */
// ======================================================================
...
namespace WeatherAnalysis
{
  ...
  // ----------------------------------------------------------------------
  /*!
   * \brief Analyze precipitation probability in an area
   *
  ...
  {
	const string varname = "textgen::precipitationprobability";
	const string parname = "PoP";
