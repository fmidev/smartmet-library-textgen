...
namespace WeatherAnalysis
{
  ...
  ComparativeAcceptor::ComparativeAcceptor(const float& theLimit /*= kFloatMissing*/,
					  const comparative_operator& theOperator /* = VOID_OPERATOR */): itsLimit(theLimit),
  ...
  boost::shared_ptr<Acceptor> ComparativeAcceptor::clone() const
  {
	return boost::shared_ptr<Acceptor>(new ComparativeAcceptor(*this));
  }
