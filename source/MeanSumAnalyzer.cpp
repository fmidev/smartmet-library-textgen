...
/*!
 * \file
 * \brief Implementation of class WeatherAnalysis::MeanSumAnalyzer
 */
// ======================================================================
...
namespace WeatherAnalysis
{
  ...
  WeatherResult
  MeanSumAnalyzer::analyze(const AnalysisSources & theSources,
