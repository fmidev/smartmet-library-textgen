...
/*!
 * \file
 * \brief Implementation of class WeatherSource
 */
// ======================================================================
...
namespace WeatherAnalysis
{
  // ----------------------------------------------------------------------
  /*!
   * \brief Implementation hiding details for WeatherSource
   */
  // ----------------------------------------------------------------------
  ...
  boost::shared_ptr<NFmiQueryData> WeatherSource::getData(const std::string & theName) const
  {
