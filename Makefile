...
analysis:
	@for f in source/*.cpp; do cmd="clang++ --analyze -I include -I /usr/include/smartmet -I /usr/include/mysql -I /usr/include/gdal -DUNIX -DFMI_COMPRESSION -DBOOST -DBOOST_IOSTREAMS_NO_LIB $$f"; echo $$cmd; $$cmd; done; rm *.plist
