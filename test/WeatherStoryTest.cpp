...
namespace WeatherStoryTest
{
  ...
  void short_overview()
  {
	...
	{
	  NFmiSettings::instance().set("a::fake::day1::precipitation","0,0");
	  NFmiSettings::instance().set("a::fake::day2::precipitation","0,0");
	  NFmiSettings::instance().set("a::fake::day3::precipitation","0,0");
	  
	  NFmiSettings::instance().set("a::fake::clear_percentage","70,0");
	  NFmiSettings::instance().set("a::fake::cloudy_percentage","20,0");
	  ...
	  NFmiSettings::instance().set("a::fake::clear_percentage","20,0");
	  NFmiSettings::instance().set("a::fake::cloudy_percentage","70,0");
	  ...
	  NFmiSettings::instance().set("a::fake::clear_percentage","10,0");
	  NFmiSettings::instance().set("a::fake::cloudy_percentage","40,0");
	  ...
	  NFmiSettings::instance().set("a::fake::clear_percentage","40,0");
	  NFmiSettings::instance().set("a::fake::cloudy_percentage","10,0");
	  ...
	  NFmiSettings::instance().set("a::fake::clear_percentage","30,0");
	  NFmiSettings::instance().set("a::fake::cloudy_percentage","30,0");
	...
	// Test rain phrases
	{
	  ...
	  NFmiSettings::instance().set("a::fake::day1::precipitation","0.2,0");
	  NFmiSettings::instance().set("a::fake::day2::precipitation","0,0");
	  NFmiSettings::instance().set("a::fake::day3::precipitation","0,0");
	  ...
	  NFmiSettings::instance().set("a::fake::day1::precipitation","2,0");
	  NFmiSettings::instance().set("a::fake::day2::precipitation","0,0");
	  NFmiSettings::instance().set("a::fake::day3::precipitation","0,0");
	  ...
	  NFmiSettings::instance().set("a::fake::day1::precipitation","0,0");
	  NFmiSettings::instance().set("a::fake::day2::precipitation","2,0");
	  NFmiSettings::instance().set("a::fake::day3::precipitation","0,0");
	  ...
	  NFmiSettings::instance().set("a::fake::day1::precipitation","0.1,0");
	  NFmiSettings::instance().set("a::fake::day2::precipitation","2,0");
	  NFmiSettings::instance().set("a::fake::day3::precipitation","0,0");
	  ...
	  NFmiSettings::instance().set("a::fake::day1::precipitation","2,0");
	  NFmiSettings::instance().set("a::fake::day2::precipitation","2,0");
	  NFmiSettings::instance().set("a::fake::day3::precipitation","2,0");
	  require(story,"fi",fun,"Sää on epävakaista.");
	  require(story,"sv",fun,"Ostadigt väder.");
	  require(story,"en",fun,"The weather is unstable.");
  ...
  void thunderprobability()
  {
	...
	NFmiSettings::instance().set("b::fake::probability","0,0");
	require(story,"fi",fun,"");
	require(story,"sv",fun,"");
	require(story,"en",fun,"");

	NFmiSettings::instance().set("b::fake::probability","5,0");
	...
	NFmiSettings::instance().set("b::fake::probability","64,0");
	...
	NFmiSettings::instance().set("b::fake::probability","99,0");
