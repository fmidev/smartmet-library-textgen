...
void integrate_time(void)
{
...

  {
    ...
    if (std::abs(result - expected) > 0.1)
      TEST_FAILED("max over time failed, got result " + lexical_cast<string>(result) +
...

  {
    ...
    if (std::abs(result - expected) > 0.1)
      TEST_FAILED("min over time failed, got result " + lexical_cast<string>(result) +
                  " instead of " + lexical_cast<string>(expected));
  }

  {
    ...
    if (std::abs(result - expected) > 0.1)
      TEST_FAILED("sum over time failed, got result " + lexical_cast<string>(result) +
                  " instead of " + lexical_cast<string>(expected));
  }

  {
    ...
    if (std::abs(result - expected) > 0.1)
      TEST_FAILED("average over time failed, got result " + lexical_cast<string>(result) +
                  " instead of " + lexical_cast<string>(expected));
  }
...
void integrate_space(void)
{
...

  {
    ...
    if (std::abs(result - expected) > 0.01)
      TEST_FAILED("maximum over helsinki failed, got result " + lexical_cast<string>(result) +
                  " instead of " + lexical_cast<string>(expected));
  }

  {
    ...
    if (std::abs(result - expected) > 0.01)
      TEST_FAILED("minimum over helsinki failed, got result " + lexical_cast<string>(result) +
                  " instead of " + lexical_cast<string>(expected));
  }
...

  {
    ...
    if (std::abs(result - expected) > 0.01)
      TEST_FAILED("minimum over uusimaa failed, got result " + lexical_cast<string>(result) +
                  " instead of " + lexical_cast<string>(expected));
  }
...
void integrate_time_space(void)
{
...

  {
    ...
    if (std::abs(result - expected) > 00.1)
      TEST_FAILED("maximum over helsinki and time failed, got result " +
                  lexical_cast<string>(result) + " instead of " + lexical_cast<string>(expected));
  }

  {
    ...
    if (std::abs(result - expected) > 0.01)
      TEST_FAILED("minimum over helsinki and time failed, got result " +
                  lexical_cast<string>(result) + " instead of " + lexical_cast<string>(expected));
  }

  {
    ...
    if (std::abs(result - expected) > 0.01)
      TEST_FAILED("maximum over uusimaa and time failed, got result " +
                  lexical_cast<string>(result) + " instead of " + lexical_cast<string>(expected));
  }

  {
    ...
    if (std::abs(result - expected) > 0.01)
      TEST_FAILED("minimum over uusimaa and time failed, got result " +
                  lexical_cast<string>(result) + " instead of " + lexical_cast<string>(expected));
  }

  {
    ...
    if (std::abs(result - expected) > 00.1)
      TEST_FAILED("maxmin over helsinki and time failed, got result " +
                  lexical_cast<string>(result) + " instead of " + lexical_cast<string>(expected));
  }

  {
    ...
    if (std::abs(result - expected) > 0.01)
      TEST_FAILED("minmax over helsinki and time failed, got result " +
                  lexical_cast<string>(result) + " instead of " + lexical_cast<string>(expected));
  }
...
void integrate_space_time(void)
{
...

  {
    ...
    if (std::abs(result - expected) > 00.1)
      TEST_FAILED("maxmin over time and helsinki failed, got result " +
                  lexical_cast<string>(result) + " instead of " + lexical_cast<string>(expected));
  }

  {
    ...
    if (std::abs(result - expected) > 0.01)
      TEST_FAILED("minmax over time and helsinki failed, got result " +
                  lexical_cast<string>(result) + " instead of " + lexical_cast<string>(expected));
  }
...
void integrate_time_space_masks(void)
{
...

  {
    ...
    float expected1 = Integrate(q, uusimaa1, spacemodifier, time1, time1, timemodifier);
    float expected2 = Integrate(q, uusimaa2, spacemodifier, time2, time2, timemodifier);

    float expected = std::max(expected1, expected2);

    if (std::abs(result - expected) > 0.01)
      TEST_FAILED("maximum over uusimaa and time failed with expanding masks, got result " +
                  lexical_cast<string>(result) + " instead of " + lexical_cast<string>(expected));
  }

  {
    ...
    if (std::abs(result - expected) > 0.01)
      TEST_FAILED("minimum over uusimaa and time failed with expanding masks, got result " +
                  lexical_cast<string>(result) + " instead of " + lexical_cast<string>(expected));
  }
...
int main(void)
{
  cout << endl << "QueryDataIntegrator tester" << endl << "=========================" << endl;
