...
ImageCenteredText($img,$size,6*$dx,0.5*$dy,$black,$font,"Day");
ImageCenteredText($img,$size,18*$dx,0.5*$dy,$black,$font,"Night");

ImageCenteredText($img,$size,1.5*$dx,1.5*$dy,$black,$font,"Morning");
ImageCenteredText($img,$size,7.5*$dx,1.5*$dy,$black,$font,"Day");
ImageCenteredText($img,$size,14*$dx,1.5*$dy,$black,$font,"Evening");
ImageCenteredText($img,$size,20*$dx,1.5*$dy,$black,$font,"Night");

ImageCenteredText($img,$size,1.5*$dx,2.5*$dy,$black,$font,"Morning");
ImageCenteredText($img,$size,4.5*$dx,2.5*$dy,$black,$font,"Before noon");
ImageCenteredText($img,$size,9*$dx,2.5*$dy,$black,$font,"Afternoon");
ImageCenteredText($img,$size,14*$dx,2.5*$dy,$black,$font,"Evening");
ImageCenteredText($img,$size,17*$dx,2.5*$dy,$black,$font,"Early night");
ImageCenteredText($img,$size,19.5*$dx,2.5*$dy,$black,$font,"Midnight");
ImageCenteredText($img,$size,22.5*$dx,2.5*$dy,$black,$font,"Late night");

ImageCenteredText($img,$size,1.5*$dx,3.5*$dy,$black,$font,"Morning");
ImageCenteredText($img,$size,4*$dx,3.5*$dy,$black,$font,"Before noon");
ImageCenteredText($img,$size,6*$dx,3.5*$dy,$black,$font,"Midday");
ImageCenteredText($img,$size,9.5*$dx,3.5*$dy,$black,$font,"Afternoon");
ImageCenteredText($img,$size,21*$dx,3.5*$dy,$black,$font,"Night");
